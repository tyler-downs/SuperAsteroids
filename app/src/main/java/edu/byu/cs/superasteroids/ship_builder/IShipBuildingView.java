...
public interface IShipBuildingView extends IView {
     ...
     */
    void setStartGameButton(boolean enabled);//once you have every single part, call setStartGameButton in the view. before that the start game button is not enabled
